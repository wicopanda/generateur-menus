...
# ==================== ENTRÉES ====================
    ...
    st.write("Ici apparaîtront les 12 entrées adaptées pour le midi.")
    if st.button("← Retour"):
        aller_a("Entrées_Choix")

elif st.session_state.page == "Entrées_Soir":
    st.header("📋 Entrées - Soir")
    st.write("Ici apparaîtront les 12 entrées adaptées pour le soir.")
    if st.button("← Retour"):
        aller_a("Entrées_Choix")
...
# ==================== PLATS ====================
    ...
    st.write("Ici apparaîtront les 12 plats adaptés pour le midi.")
    if st.button("← Retour"):
        aller_a("Plats_Choix")
...
# ==================== DESSERTS ====================
    ...
    st.write("Ici apparaîtront les 12 desserts adaptés pour le midi.")
    if st.button("← Retour"):
        aller_a("Desserts_Choix")
